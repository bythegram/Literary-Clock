...
│   ├── temporal-polyfill.js    # @js-temporal/polyfill v0.5.1 UMD bundle; always loaded before app.js; exposes Temporal globally only when not natively available (e.g. iOS PWA standalone)
