...
| Temporal Polyfill | [`@js-temporal/polyfill`](https://github.com/js-temporal/temporal-polyfill) v0.5.1 — self-hosted at `docs/temporal-polyfill.js`; ensures the Temporal API works in environments where it is not yet natively available (e.g. iOS PWA standalone mode) |
